...
function shoppingTime(memberId, money) {
    ...
    var objectBelanja = {}
    objectBelanja.memberId = memberId
    objectBelanja.money = money
    objectBelanja.listPurchased = listBelanja
    objectBelanja.changeMoney = kembalian
  
    return objectBelanja
